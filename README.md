[OneChunk](https://www.spigotmc.org/resources/onechunk.87527/) will limit a player to only see one chunk at a time. The best way to understand this is to see a video.
